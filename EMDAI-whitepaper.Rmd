...
abstract: Triage tools based on Machine Learning offer a promising approach to enhancing
  ...
  and hospital outcomes. We also provide an online tool for exploring our free-text data.
toc: yes
urlcolor: blue
---
...
testparams <- alist(data = dat, 
                    ...
                    nrounds = 100,
                    maximize = T,
                    max_depth = 2, # This get changed to 6
                    nfold = 5,
                    verbose = F,
                    prediction = T,
                    eval_metric = "auc",
...
Each indicator improves steadily with the addition of additional predictors, with the exception of 3 day mortality which does not appear to improve with the addition of free-text questions.. Recall that AUC is sensitive to unbalance in datasets (i.e., having large numbers of negative cases improves AUC), and as such, comparisons between outcomes here are unreliable.
