...
Each indicator improves steadily with the addition of additional predictors, with the exception of 3 day mortality which deos not appear to improve with the addition of free-text questions.. Recall that AUC is sensitive to unbalance in datasets (i.e., having large numbers of negative cases improves AUC), and as such, comparisons between outcomes here are unreliable.
